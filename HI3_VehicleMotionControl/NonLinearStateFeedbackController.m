classdef NonLinearStateFeedbackController < ControllerBase
    properties
        K;
        L;
        plan;
    ...
    methods
        function obj=NonLinearStateFeedbackController(K, L, path, goal_tol)
            if nargin < 4
                goal_tol = 1;
            end
        ...
        function c = u(obj, t, w)
            ...
            maclaurin = 1 - theta_e^2/6 + theta_e^4/120 - theta_e^6/5040;
            u0 = obj.plan.c(s+1) - obj.K(1)*maclaurin*d-obj.K(2)*theta_e;
