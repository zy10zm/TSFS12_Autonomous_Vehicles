classdef ModelPredictiveController < ControllerBase
    ...
    methods
        ...
        function theta_e = heading_error(obj, theta, s)
            ...
            theta_e = atan2(help_sin(3),help_cos);
        end
        ...
        function optimizer = construct_problem(obj)
            ...
            J = sum(obj.gamma_d*sumsqr(proj_error) + ...
                obj.gamma_theta*sumsqr(head_error) + ...
                obj.gamma_u*sumsqr(Delta));
            
            opti.minimize(J); % argmin(J)
        ...
        function ret = error_model(obj, w, v, delta, curvature)
            ...
            % YOUR CODE HERE
            d_dot = v*w(2);
            theta_e_dot = v*(delta/obj.L - curvature);
        ...
        function c = u(obj, ~, w)
            ...
            si = obj.s0;  % Position for start of prediction
            ...
            Delta = full(evalf(obj.optimizer(d, theta_e, v, obj.plan.c(s_horizon))));
            
            % Collect the controller output
            delta = Delta(1);  % Använder mig av styrsignalen "närmast i tiden"
            acc = 0;
